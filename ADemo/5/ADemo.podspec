...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/learnmodulizationdemo/ADemo"
  ...
  s.source       = { :git => "https://github.com/learnmodulizationdemo/ADemo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ADemo/ADemo/**/*.{h,m,swift}"
